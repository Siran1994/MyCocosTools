import { _decorator, Component, MeshRenderer, Color, Vec3, Vec2, Vec4 } from 'cc';
const { ccclass, property } = _decorator;
const desPos = new Vec3;
const tempV1 = new Vec3;
const tempV2 = new Vec3( 1, 1, 1 );
const tOffset = new Vec2( 1, 1 );
const gayColor = new Color( 0, 255, 0, 255 ) /* 导航线颜色 */
...
export class NavLineComp extends Component
{
    ...
    setDis ()
    {
        ...
        this.lineMesh.material.setProperty( "tilingOffset", new Vec4( 1, this.desLen, 0, this.desLen ) );

        this.node.lookAt( desPos );
    }
