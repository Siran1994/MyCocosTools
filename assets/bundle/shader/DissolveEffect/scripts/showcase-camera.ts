...
export class FirstPersonCamera extends Component {
    ...
    public update (dt: number) {
        ...
        if(this.moveDir.lengthSqr()){
            ...
            Vec3.scaleAndAdd(this._position, this._position, forward, this.moveSpeed * this._speedScale * this.moveDir.y);
            Vec3.lerp(v3_1, this.node.getPosition(), this._position, t);
            this.node.setPosition(v3_1);
    ...
    updateDirection(){
        ...
        console.log('info',keyCode1,keyCode0,keyCode1 * 1000 + keyCode0);
        this.moveDir = this.key2dirMap[keyCode1 * 1000 + keyCode0];
        console.log('dir',this.moveDir.x,this.moveDir.y);
    }
}
