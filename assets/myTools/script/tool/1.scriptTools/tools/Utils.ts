import { v2, resources, Component } from "cc";
...
{    
   ...
   */
    ...
    */
    ...
    public static startTimer(interval: number, repeatCount: number, callback: Function) 
    {
        this.count = 0;
    ...
    public static rand(arr: any) {
     ...
     /** 获得两个节点的距离 */
    // public static getDistance(startNode:Node,endNode:Node)
    // {
    //     let startPos=startNode.position;
    //     let endPos=endNode.position;
    //     let temp=startPos.sub(endPos);
    //     return temp.mag();
    // }
    ...
    //     let curBoundingBox = currentNode.getBoundingBoxToWorld();
    //     let tarBoundingBox = targetNode.getBoundingBoxToWorld();
    ...
    //     let curNodePosition = currentNode.parent.convertToWorldSpaceAR(currentNode.position);
    //     let tarBoundingBox = targetNode.getBoundingBoxToWorld();
