import { _decorator, Component, Node, Prefab, loader, instantiate, ICollisionEvent, ColliderComponent, Vec3, Quat, director } from 'cc';
...
export class ContactPointHelper extends Component
{
    ...
    __preload ()
    {
        ...
        if ( ContactPointHelper._container == null )
        {
            ...
            director.addPersistRootNode( ContactPointHelper._container );
        }
    }
