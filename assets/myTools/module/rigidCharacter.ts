...
import { _decorator, Component, Vec3, RigidBodyComponent, EPSILON, ColliderComponent, ICollisionEvent, IContactEquation, Collider } from 'cc';
...
export class RigidCharacter extends Component
{
    ...
    GameOver ( isfailed: boolean )
    {
        ...
        this.node.worldPosition = new Vec3( this.node.worldPosition.x, 0, this.node.worldPosition.z );
    }
    move ( dir: Vec3, speed: number )
    {
        ...
        const ms = GameManager.Instance.Speed;
